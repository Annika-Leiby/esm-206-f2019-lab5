...
We'll use the 'lubridate' package to convert to Date format, and then to help us eaily parse month & year
...
Use t.test() function to find confidence intervals (for one sample) and perfomr t-tests to compare means of the samples (... this will b covered conceptually in lectures week 6)
...
We want to ask: Is there a significant differene in lobster legths at Naples and Mohawk reefs?
...
Here is the t-statistic: `r mn_ttest2Sp.value`

Here is my p-value `r mn_ttest2$p.value
